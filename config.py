...
# Run 8: 2003, Run 9: 2011 (50% co-evol replicate 1), Run 10: 2012 (50% co-evol replicate 2)
RANDOM_SEED = 2012
...
# Run 1: 0.6, Run 2-5: 0.4, Run 6-8: 0.30, Run 9-11: 0.50 (Condition B)
COEVOLUTION_RATIO_8x8_RUN1 = 0.6  # 60% co-evolved opponents
COEVOLUTION_RATIO_8x8 = 0.50     # Run 9: 50% co-evolved, 50% random (Condition B)
...
# ============================================================================
# TEST PROTOCOL (post-evolution evaluation)
# ============================================================================
# Supervisor: multiple test seeds (5-10), more test games (30+). Opponent set fixed.
# Used for fair comparison and CI / variance across seeds.
TEST_SEEDS_8x8 = [888, 889, 890, 891, 892]   # 5 seeds; fixed opponent set per seed
TEST_SEEDS_6x6 = [999, 1000, 1001, 1002, 1003]
TEST_GAMES_PER_SEED = 30   # 30+ games per seed
# Opponent: random baseline only. Same seeds = same opponent sequences for all strategies.
